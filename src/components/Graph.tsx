...
const Graph = memo(function Graph({ shouldResize,visibleFlow,setVisibleFlow }: { shouldResize: number,visibleFlow:boolean,setVisibleFlow:Dispatch<SetStateAction<boolean>>  }) {
  useCytoscapeStyleImports();
  ...
  return (
    ...
    >
      ...
      <GraphContextMenu visibleFlow={visibleFlow} setVisibleFlow={setVisibleFlow}/>
    </Box>
  );
});
