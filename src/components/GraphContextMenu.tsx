...
import { Dispatch, memo, ReactNode, SetStateAction, useMemo, useReducer } from "react";
...
export const GraphContextMenu = memo(function GraphContextMenu({visibleFlow,setVisibleFlow}:{visibleFlow:boolean,setVisibleFlow:Dispatch<SetStateAction<boolean>>}) {
    ...
    >
      ...
      <Item
        onClick={() => {
          ...
          setVisibleFlow(visibleFlow => !visibleFlow)
        }}
      >
