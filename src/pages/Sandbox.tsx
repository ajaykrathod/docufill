...
const Sandbox = memo(function Edit({ editorText,handleChange }: props) {
  ...
  const onChange = useCallback<OnChange>(
    (value) => {
      useDoc.setState({ text: value ?? "" }, false, "Edit/text")
  ...
  useEffect(() => {
    if(editorText) useDoc.setState({ text: editorText }, false, "Edit/text")
  }, [editorText]);
 ...
 */
function EditOuter({ editorText,handleChange }: props) {
  ...
  return <Sandbox handleChange={handleChange} editorText={editorText} />;
}
